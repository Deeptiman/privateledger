...
func (app *HtmlApp) processAuthentication(w http.ResponseWriter, key string) string {
...
func (app *HtmlApp) hasSavedToken(endpoint func(http.ResponseWriter, *http.Request, string)) func(http.ResponseWriter, *http.Request) {
...
func (app *HtmlApp) isAuthorized(endpoint func(http.ResponseWriter, *http.Request)) func(http.ResponseWriter, *http.Request) {
